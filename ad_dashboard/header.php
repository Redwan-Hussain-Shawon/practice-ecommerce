...
<head>
    ...
    <link rel="stylesheet" href="assets/theme/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="assets/theme/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="assets/theme/plugins/daterangepicker/daterangepicker.css">
    <!-- summernote -->
